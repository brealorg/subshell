...
**Public beta available — 0.77.0-beta.3**

**subshell** is an independent Android client for Reddit, built for
everyday Reddit use with a Material 3 interface.

**[Download the current public beta](https://github.com/brealorg/subshell/releases/tag/v0.77.0-beta.3)**
...
**0.77.0-beta.3** is the current public beta of subshell.
